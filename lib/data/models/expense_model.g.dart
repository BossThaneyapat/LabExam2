...
int _expenseEstimateSize(
  ...
  bytesCount += 3 + object.itemPrices.length * 8;
...
void _expenseSerialize(
  ...
  writer.writeStringList(offsets[2], object.itemNames);
  writer.writeDoubleList(offsets[3], object.itemPrices);
...
Expense _expenseDeserialize(
  ...
  object.id = id;
  object.itemNames = reader.readStringList(offsets[2]) ?? [];
  object.itemPrices = reader.readDoubleList(offsets[3]) ?? [];
...
extension ExpenseQueryFilter
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemNamesElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemNamesElementBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemNamesElementMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemNamesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemNamesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'itemNames',
        0,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemNamesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'itemNames',
        0,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemNamesLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemNamesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition>
      itemPricesElementEqualTo(
    double value, {
    double epsilon = Query.epsilon,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'itemPrices',
        value: value,
        epsilon: epsilon,
      ));
    });
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemPricesLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'itemPrices',
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemPricesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'itemPrices',
        0,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemPricesIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'itemPrices',
        0,
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> itemPricesLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByItemNames() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'itemNames');
    });
  }

  QueryBuilder<Expense, Expense, QDistinct> distinctByItemPrices() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'itemPrices');
    });
  }
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, List<String>, QQueryOperations> itemNamesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'itemNames');
    });
  }

  QueryBuilder<Expense, List<double>, QQueryOperations> itemPricesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'itemPrices');
    });
  }
